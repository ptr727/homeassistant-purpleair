"""Adds config flow for PurpleAir."""
...
from .api import (
    ...
    PurpleAirApiClientCommunicationError,
    PurpleAirApiClientError,
)
from .const import DOMAIN, LOGGER


class PurpleAirFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            try:
                ...
                _errors["base"] = "auth"
            except PurpleAirApiClientCommunicationError as exception:
